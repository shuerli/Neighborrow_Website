class FeedbackController < ApplicationController
	...
	def show
		case params[:scope]
		when 'user'
			as_lender_query = "SELECT Feedback_to_lenders.* FROM Feedback_to_lenders, Requests, Itens WHERE Feedback_to_lenders.request_id = Requests.id AND Requests.item_id = Itens.id AND Itens.owner = '';" 
			...
			as_lender_rate_query = "SELECT AVG(Feedback_to_lenders.rate) FROM Feedback_to_lenders, Requests, Itens WHERE Feedback_to_lenders.request_id = Requests.id AND Requests.item_id = Itens.id AND Itens.owner = '';";
